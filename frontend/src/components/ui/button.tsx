  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-[8px] border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        tint:
          "bg-sky-tint text-notion-blue hover:bg-[color-mix(in_oklch,var(--color-sky-tint),var(--color-notion-blue)_10%)] aria-expanded:bg-[color-mix(in_oklch,var(--color-sky-tint),var(--color-notion-blue)_10%)] dark:bg-sky-tint/15 dark:text-sky-wash dark:hover:bg-sky-tint/25",
        destructive:
      ...
      size: {
        default:
          "h-11 min-h-[44px] gap-1.5 px-4 has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3",
        ...
        sm: "h-9 min-h-9 gap-1 rounded-[min(var(--radius-md),12px)] px-3 text-[0.8rem] in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
        lg: "h-11 min-h-[44px] gap-1.5 px-5 has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3",
        touch: "h-11 min-h-[44px] min-w-[44px] gap-1.5 px-4",
